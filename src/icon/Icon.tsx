...
function Icon({ type }: IPropsIcon) {
    switch (type) {
        case "comments":
            return (
                <svg width="15" height="15" viewBox="0 0 15 15" fill="#999999" xmlns="http://www.w3.org/2000/svg">
        ...
        case "share":
            return (
                <svg width="12" height="14" viewBox="0 0 12 14" fill="#999999" xmlns="http://www.w3.org/2000/svg">
