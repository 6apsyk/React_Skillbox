...
import { IIconSize } from "../interfaceIcon";
interface ICommentsProps {
    size: IIconSize;
}

function Comments({ size }: ICommentsProps) {
    return (
        <svg width={size || 15} height={size || 15} viewBox="0 0 15 15" fill="#999999" xmlns="http://www.w3.org/2000/svg">
